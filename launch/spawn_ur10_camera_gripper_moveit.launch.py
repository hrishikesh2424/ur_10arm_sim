...
def generate_launch_description():
    ...
    joint_controllers_file = os.path.join(
        get_package_share_directory('ur_yt_sim'), 'config', 'ur10_controllers_gripper.yaml'
    )
    ...
    moveit_config = (
        MoveItConfigsBuilder("custom_robot", package_name="u10_camera_gripper_moveit_config")
    ...
    rviz_config_path = os.path.join(
        get_package_share_directory("u10_camera_gripper_moveit_config"),
        "config",
        "moveit.rviz",
    )
